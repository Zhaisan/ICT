...
namespace Example2
{
    class Layer
    {
        ...
        public Layer(DirectoryInfo dir, int pos)
        {
            ...
            content.AddRange(this.dir.GetDirectories()); //Добавляет массив в наш лист
    ...
    class Program
    {
            ...
            while (!escape)
            {
                ...
                switch (consoleKeyInfo.Key)
                {
                    ...
                    case ConsoleKey.UpArrow:
                        history.Peek().SetNewPosition(-1); //Peek is the top of the list
        ...
        private static void F2()
        {
            while (true)
            {
                ConsoleKeyInfo consoleKeyInfo = Console.ReadKey(); //ConsoleKey: A value that identifies the console key that was pressed.
